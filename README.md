# <img src="img/ai_foundry.png" alt="Azure Foundry" style="width:70px;height:40px;"/> Using Azure API Management as MCP Registry for Azure AI Foundry Agent Service
